...
class Admin extends CI_Controller
{
    ...
    public function productos()
    {
        ...
        $lista = $this->Admin_model->listaproductos();
    ...
    public function modificarproducto()
    {
        ...
        $data['infoproducto'] = $this->Admin_model->recuperarproducto($id_producto);
        $this->load->view('inc/head');
        $this->load->view('inc/menu');
    ...
    {
        $lista = $this->Admin_model->listaproductoseliminados();
        $data['productos'] = $lista;
    ...
    {
        $id_producto=$_POST['id_producto'];
        $this->Admin_model->eliminarproducto($id_producto);
    ...
    public function deshabilitarproductodb()
    {
        ...
        $this->Admin_model->modificarproducto($id_producto, $data);
        redirect('Admin/productos', 'refresh');
    }
    ...
    public function modificarproductodb()
    {
        ...
        $id_producto = $this->input->post('id_producto');  // Usar $this->input->post en lugar de $_POST para consistencia
        $data['nombre'] = strtoupper($this->input->post('nombre'));
        $data['categoria'] = $this->input->post('categoria');
        $data['stock'] = $this->input->post('stock');
        $data['precio'] = $this->input->post('precio');
        $data['imagen'] = strtoupper($this->input->post('imagen'));
    ...
    public function habilitarproductobd()
    {
        ...
        $this->Admin_model->modificarproducto($id_producto, $data);
        redirect('Admin/eliminadosproductos', 'refresh');
    }
}
?>
