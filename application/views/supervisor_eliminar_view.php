    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 id="title">ELIMINAR TICKET</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <div class="card-info">
            <div class="card-body">
                <div class="search-container">
                    <form method="POST" action="<?php echo base_url('index.php/supervisor/eliminarTicket'); ?>" id="searchForm">
    ...
    $('#eliminar').click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '<?php echo base_url('index.php/supervisor/procesarEliminacionTicket'); ?>',
                    type: 'POST',
                    data: {
                        orden_id: orden_id
                    },
