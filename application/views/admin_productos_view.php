...
<head>
              ...
              <tr>
                ...
                <td class="text-center">
                  <div class="btn-group-ac">
                    ...
                    <?php echo form_open_multipart("Productos/eliminarproductodb", ['class' => 'formEliminar']); ?>
                    <input type="hidden" name="id_producto" value="<?php echo $row->id_producto; ?>">
                    <button type="submit" class="btn btn-danger eliminar-btn"><i class="fas fa-trash-alt"></i></button>
                    <?php echo form_close(); ?>

                    <?php echo form_open_multipart("Productos/deshabilitarproductodb", ['class' => 'formDeshabilitar']); ?>
                    <input type="hidden" name="id_producto" value="<?php echo $row->id_producto; ?>">
  ...
  <script>
    $(document).ready(function() {
      ...
      // Confirmación de deshabilitación (con delegación de eventos)
      $(document).on('click', '.deshabilitar-btn', function(e) {
        e.preventDefault();
        const form = $(this).closest('form');
