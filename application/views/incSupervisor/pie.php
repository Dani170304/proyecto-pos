...
}).buttons().container().appendTo('#eventos_wrapper .col-md-6:eq(0)');
    ...
    "buttons": [
        {
            ...
            filename:'reporte_ticket_eliminado',
            title: 'Reporde de Tickets Eliminados'
        },
        {
            ...getPDFConfig('Reporte de Tickets Eliminados'),
            exportOptions: {
                columns: [0, 1, 2, 3]
            },
            filename:'reporte_ticket_eliminado'
...
$("#tablaProductosVendidos").DataTable({
    ...
    "buttons": [
        {
            ...
            filename:'reporte_producto_mas_vendido',
            title: 'Reporte de Productos Más Vendidos'
        },
        {
            ...getPDFConfig('Reporte de Productos Más Vendidos', true),
            exportOptions: {
                columns: [0, 1, 2, 3, 4]
            },
            filename:'reporte_producto_mas_vendido'
    ...
    // ... resto de la configuración de tablaProductosVendidos ...
